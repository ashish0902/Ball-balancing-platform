...
def init_setup(rec_client_id):
	...
	global joint_1,joint_2,joint_3,joint_4,joint_5,joint_6,joint_7,joint_8
	...
	# to get the handle of x axis servo
	return_code,joint_1 = sim.simxGetObjectHandle(client_id,'revolute_joint_ss_1',sim.simx_opmode_oneshot_wait)
	return_code,joint_2 = sim.simxGetObjectHandle(client_id,'revolute_joint_ss_2',sim.simx_opmode_oneshot_wait)
	
	# x axis
	return_code,joint_3  = sim.simxGetObjectHandle(client_id,'revolute_joint_ss_3',sim.simx_opmode_oneshot_wait)
	return_code,joint_4 = sim.simxGetObjectHandle(client_id,'revolute_joint_ss_4',sim.simx_opmode_oneshot_wait)
	
	# y axis
	return_code,joint_5 = sim.simxGetObjectHandle(client_id,'revolute_joint_ss_5',sim.simx_opmode_oneshot_wait)
	# print(return_code)
	return_code,joint_6 = sim.simxGetObjectHandle(client_id,'revolute_joint_ss_6',sim.simx_opmode_oneshot_wait)
	# print(return_code)
	# y axis
	return_code,joint_7  = sim.simxGetObjectHandle(client_id,'revolute_joint_ss_7',sim.simx_opmode_oneshot_wait)
	return_code,joint_8 = sim.simxGetObjectHandle(client_id,'revolute_joint_ss_8',sim.simx_opmode_oneshot_wait)
...
def control_logic(center_x,center_y):
	...
	"""
	global setpoint, client_id , xkp ,xki , xkd , xerrorsum , xlasterror , yerrorsum , ylasterror, ykp ,yki , ykd 
	
	##############	ADD YOUR CODE HERE	##############
	
	
	# print(setpoint)
	xerror = center_x-setpoint[0]
	xerrorsum += xerror
	xderror = xerror-xlasterror

	xoutput = xkp*xerror + xki*xerrorsum + xkd*xderror

	yerror = center_y-setpoint[1]
	yerrorsum += yerror
	yderror = yerror-ylasterror

	youtput = ykp*yerror + yki*yerrorsum + ykd*yderror
	...
	return_code = sim.simxSetJointTargetPosition(client_id,joint_1, (youtput/1500) ,sim.simx_opmode_oneshot_wait)
	# print(return_code)
	return_code = sim.simxSetJointTargetPosition(client_id,joint_2, -(youtput/1500) ,sim.simx_opmode_oneshot_wait)
	# print(return_code)

	return_code = sim.simxSetJointTargetPosition(client_id,joint_3,-(xoutput/1500) ,sim.simx_opmode_oneshot_wait)
	# print(return_code)
	return_code = sim.simxSetJointTargetPosition(client_id,joint_4,(xoutput/1500) ,sim.simx_opmode_oneshot_wait)
	# print(return_code)
	# return_code = sim.simxSetJointTargetPosition(client_id,joint4, -(xoutput/3000) ,sim.simx_opmode_oneshot_wait)
	# _,pos = sim.simxGetJointPosition(client_id,joint1,sim.simx_opmode_oneshot_wait)
	# print(pos)

	# return_code = sim.simxSetJointTargetPosition(client_id,joint2, -(xoutput/2000) ,sim.simx_opmode_oneshot_wait)
	
	return_code = sim.simxSetJointTargetPosition(client_id,joint_5, -(youtput/1500) ,sim.simx_opmode_oneshot_wait)
	# print(return_code)
	return_code = sim.simxSetJointTargetPosition(client_id,joint_6, (youtput/1500) ,sim.simx_opmode_oneshot_wait)
	# print(return_code)
	# return_code = sim.simxSetJointTargetPosition(client_id,joint1, -(youtput/2000) ,sim.simx_opmode_oneshot_wait)
	# _,pos = sim.simxGetJointPosition(client_id,joint4,sim.simx_opmode_oneshot_wait)

	return_code = sim.simxSetJointTargetPosition(client_id,joint_7, (xoutput/1500) ,sim.simx_opmode_oneshot_wait)
	# print(return_code)
	return_code = sim.simxSetJointTargetPosition(client_id,joint_8, -(xoutput/1500) ,sim.simx_opmode_oneshot_wait)
	# print(return_code)
	# return_code = sim.simxSetJointTargetPosition(client_id,joint3, (youtput/2000) ,sim.simx_opmode_oneshot_wait)
	# print(return_code)
